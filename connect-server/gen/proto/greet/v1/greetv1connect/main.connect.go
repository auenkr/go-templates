...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/auenkr/go-templates/connect-server/gen/proto/greet/v1"
	http "net/http"
	strings "strings"
)
...
var (
	greetServiceServiceDescriptor     = v1.File_proto_greet_v1_main_proto.Services().ByName("GreetService")
